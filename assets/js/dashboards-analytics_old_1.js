...
if (totalRevenueChartEl) {
  const totalRevenueChartOptions = {
    ...
    // ✅ Judul & subtitle untuk Dec 2025
    title: {
      text: 'Hourly Traffic Pattern – Dec 2025',
      style: { fontSize: '14px', fontWeight: 600 }
    },
    subtitle: {
      text: 'Pasir Kaliki (sample) – estimated potential views by hour',
      style: { fontSize: '12px' }
    },
    ...
    series: [
      {
        name: 'Potential Views (Index)',
        data: [6, 4, 3, 3, 4, 8, 16, 22, 18, 14, 13, 14, 15, 14, 15, 18, 24, 28, 26, 20, 15, 11, 9, 7]
      }
    ],
